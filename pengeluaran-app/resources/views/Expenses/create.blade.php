...
@section('content')
    <style>
        ...
        button[type="submit"] {
            ...
            border: none;
            border-radius: 5px;
            padding: 15px 20px; /* Padding ditingkatkan untuk memberikan lebih banyak ruang */
            cursor: pointer;
            transition: background-color 0.3s ease;
            margin-bottom: 20px; /* Ruang bawah ditambahkan untuk tombol */
        }
    ...
    <form action="{{ route('Expenses.create') }}" method="POST">
        ...
        <input type="number" name="amount" placeholder="Amount" value="{{ old('amount') }}"><br>
